...
Public Class BBA_set_question
    ...
    Private Sub Setquestion_Panel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
       ...
       .Connection = connection,
        .CommandText = "Select max(question_id) from tbl_bba_question"}
        connection.Open()
    ...
    Private Sub Submit_button_Click(sender As Object, e As EventArgs) Handles Submit_button.Click
        ...
        ElseIf Opt2_RadioButton.Checked = True Then
            correct_answer = "D"
        End If
        command.CommandText = "insert into tbl_bba_question values('" & Question_textbox.Text & "','" & Opt_box1.Text & "','" & Opt_box2.Text & "','" & Opt_box3.Text & "','" & Opt_box4.Text & "','" & correct_answer & "')"
